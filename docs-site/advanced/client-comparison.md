...
ProxieHub 提供 Clash、V2Ray、HTTP/SOCKS5 三种订阅格式，几乎覆盖所有主流代理客户端。本页对比各平台常用客户端，帮助你根据设备、协议需求与预算选择合适的工具。
...
| 浏览器分流 | SwitchyOmega / FoxyProxy | HTTP/SOCKS5 |
...
```
https://raw.githubusercontent.com/MS33834/ProxieHub/main/nodes/proxies.txt
```
