...
Clash Verge Rev 是 Clash 系客户端在 Windows、macOS 与 Linux 上的主流图形化分支，支持 Clash / Clash Meta 内核，适合使用 ProxieHub 的 Clash 订阅。
...
2. 点击 **导入** 或 **新建** 按钮。
3. 在 URL 输入框中粘贴 ProxieHub 的 Clash 订阅地址：
   ```
...
ProxieHub 每日 UTC 02:00 自动更新节点，建议每天至少手动更新一次。
