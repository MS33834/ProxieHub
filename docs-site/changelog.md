...
本页面汇总 ProxieHub 仓库的关键变更。完整原始日志请查看仓库根目录的 [`CHANGELOG.md`](https://github.com/MS33834/ProxieHub/blob/main/CHANGELOG.md)。

## [未发布]

### 新增

- 扩展 VitePress 文档站，新增[架构](/architecture)、[参与贡献](/contributing)、[路线图](/roadmap)、[更新日志](/changelog)、[项目状态](/status)与[客户端对比](/advanced/client-comparison)页面。
...
- 初始化 ProxieHub 仓库，包含 MIT 许可证、行为准则、安全政策与贡献指南。
