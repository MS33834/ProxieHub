...
| Format | Raw URL |
|---|---|
| Clash | `https://raw.githubusercontent.com/MS33834/ProxieHub/main/nodes/clash.yaml` |
| V2Ray | `https://raw.githubusercontent.com/MS33834/ProxieHub/main/nodes/v2ray.txt` |
| HTTP/SOCKS5 | `https://raw.githubusercontent.com/MS33834/ProxieHub/main/nodes/proxies.txt` |
...
3. `scripts/verifier.py` performs lightweight connectivity/latency checks.
4. `scripts/formatter.py` generates `clash.yaml`, `v2ray.txt`, and `proxies.txt`.
5. GitHub Actions runs the pipeline daily at 02:00 UTC and commits updates.
